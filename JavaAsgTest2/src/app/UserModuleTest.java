...
public class UserModuleTest {
	...
	private static final SmartMetroTicketingSystem smartMetroTicketingSystem = new SmartMetroTicketingSystem();
...
/*
        ...
        while (running) {
            ...
            switch (choice) {
                ...
                default -> System.out.println("Invalid choice. Please enter number 0 - 6.");
            }
            System.out.println();
        }
    }*/
    ...
    public void login() {
        ...
        try {
            ...
            if(user.getRole() == UserRole.ADMIN) {
                smartMetroTicketingSystem.adminMenu();
				//admin.adminMenu();
            }
            
            if(user.getRole() == UserRole.PASSENGER) {
            	smartMetroTicketingSystem.passengerMenu(passenger);
            	//passenger.passengerMenu(passenger);
            }
        } 

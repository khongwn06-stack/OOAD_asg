...
/**
 * Standalone menu-driven driver to test ONLY the user module.
 * In the final merged project this logic moves into app/Main.java,
 * combined with the ticket, station, train, route and report menus.
 *
 * Test scenarios covered here:
 *   - Register a new passenger
 *   - Login with correct password
 *   - Login with wrong password  (InvalidLoginException)
 *   - View profile
 *   - View all users (sorted)
 *   - Top up passenger balance
 *   - Save data / load data (users.txt)
 */
